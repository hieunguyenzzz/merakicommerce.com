      ...
      <section >
        <Hero {...{
          ...
          <p style={{ animationDelay: '500ms' }} className="custom-breadcrumbs aos-init aos-animate text-lg animate__animated animate__fadeInUp " data-aos="fade-up" data-aos-delay="100">
            <Link href="/" className="underline">Home</Link> <span className="mx-3">/</span> Our Projects</p>
        </Hero>
      </section>
      <section>
        <Container className="py-28 ">
          <AnimationGroup>
            {
              (createProps) => <div className='space-y-8 flex  flex-col items-center text-center'>
                <h2 {...{
                  ...createProps(0, "text-4xl font-semibold font-heading")
                }} >{get('homepage.feature_project_heading', 'Selected Work')}</h2>
                <p {...{
                  ...createProps(1, "max-w-prose")
                }} >{get('homepage.feature_project_body', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis accusamus perferendis libero accusantium nisi.')}</p>
