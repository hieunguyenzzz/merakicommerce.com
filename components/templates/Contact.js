          ...
          <AnimationGroup className="flex flex-col space-y-20">
            {
              getProps => {
                return <>
                  <div className="flex-1 ml-auto flex space-x-8 w-full justify-between">
                    ...
                    <div  {...getProps(1, "flex items-start space-x-4 flex-1 justify-center")} >
                    ...
                    <div  {...getProps(2, "flex items-start space-x-4 flex-1 justify-end")} >
                      <div className="text-primary text-icon w-10 h-10 flex justify-center items-center flex-shrink-0">
                  ...
                  <from {...getProps(3, "mb-10 md:mb-0  grid grid-cols-2 gap-8 order-1 ")} >
